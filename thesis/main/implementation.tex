...
$$ L(\overline{\omega} | X \in C) = P(X \in C; \overline{\omega}) $$
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{treeS3vsS3mini}
